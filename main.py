...
def upload_dim_users():
    """
    This function is used to upload the extracted and cleaned data from a relational AWS database to the pgAdmin database.
    """
...
def upload_dim_card_details():
    """
    This function is used to upload the extracted and cleaned data from a pdf to the pgAdmin database.
    """
    connector = DatabaseConnector('db_creds.yaml')
    extractor = DataExtractor()
    cleaner = DataCleaning()
...
def upload_dim_store_details():
    """
    This function is used to upload the extracted and cleaned data using an API to the pgAdmin database.
    """
    connector = DatabaseConnector('db_creds.yaml')
    extractor = DataExtractor()
    cleaner = DataCleaning()
...
def upload_dim_products():
    """
    This function is used to upload the extracted and cleaned data from an S3 bucket to the pgAdmin database.
    """
    connector = DatabaseConnector('db_creds.yaml')
    extractor = DataExtractor()
    cleaner = DataCleaning()
...
def upload_orders_table():
    """
    This function is used to upload extracted and cleaned data from a relational AWS database to the pgAdmin database.
    """
    connector = DatabaseConnector('db_creds.yaml')
    extractor = DataExtractor()
    cleaner = DataCleaning()
